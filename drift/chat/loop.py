...
from drift.embeddings import build_text_embedder, build_image_embedder
from drift.undo import clear_last_action, save_last_move
from drift.chat.tools import (
    ToolResult,
    tool_definitions,
    tool_duplicates,
    tool_delete,
...
from drift.chat.tools.plan_ops import build_move_plan, parse_structure_suggestions
from drift.chat.tools.previews import (
...
from drift.chat.system_prompt import get_system_prompt
from drift.indexer import Indexer
from drift.store import ChromaStore, MetadataStore

console = Console()
_STATUS_UPDATE_INTERVAL = 0.2
AUTO_STRUCTURE_TREE = os.environ.get("DRIFT_AUTO_STRUCTURE_TREE", "0") == "1"
...
def chat_loop() -> None:
    ...
    console.print(
        Panel(
            "[bold cyan]Drift[/bold cyan] chat (GPT-4o)\n"
