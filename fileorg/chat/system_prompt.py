...
def get_system_prompt() -> str:
    return (
        ...
        "- Root folders (sorted): work/professional/, personal/life/, learning/, creative/, system/dev/, random/junk/. Prefer shallow, direct paths (e.g., learning/python, creative/design-drafts) instead of extra middle layers like learning/academy/python or creative/media/design-drafts. Only add an extra level if truly necessary to disambiguate.\n"
