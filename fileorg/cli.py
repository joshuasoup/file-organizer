...
def index(
    ...
    from fileorg.indexer.types import FileInfo
...
def structure(
    ...
    from fileorg.chat.tools.previews import display_structure_tree
    from fileorg.chat.tools import tool_suggest_structure
    from fileorg.store import ChromaStore
